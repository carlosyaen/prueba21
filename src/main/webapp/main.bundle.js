...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_observable_IntervalObservable__ = __webpack_require__(145);
...
var AppComponent = (function () {
        ...
        this.http.get(this.urlJenkins + this.finalURL).subscribe(function (response) {
            ...
            for (var i = 0; i < data.jobs.length; i++) {
                _this.http.get(data.jobs[i].url + _this.finalURL).subscribe(function (response) {
                    ...
                    var lastOneNumber = 0;
                    var numOfFails = 0;
                    for (var _i = 0, jobsAux_1 = jobsAux; _i < jobsAux_1.length; _i++) {
                        var jA = jobsAux_1[_i];
                        console.log(jA);
                    }
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_3_rxjs_observable_IntervalObservable__["IntervalObservable"].create(7000).subscribe(function (reponse) {
            _this.getAllTheJobs();
        });
    };
    /*
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_zone_js_dist_zone__ = __webpack_require__(113);
